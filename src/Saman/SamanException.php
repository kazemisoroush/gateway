...
class SamanException extends BankException {
    ...
    public $errors = [
        ...
        'Incorrect PIN'                        => 'رمز کارت اشتباه وارد شده است.',
        ...
        'Allowable PIN Tries Exceeded Pick Up' => 'رمز کارت ۳ مرتبه اشتباه وارد شده است در نتیجه کارت شما غیر فعال خواهد شد.',
        'Response Received Too Late'           => 'تراکنش در شبکه بانکی وقفه خورده است.',
        ...
        - 3                                    => "ورودی ها حاوی کاراکترهای غیر مجاز هستند.",
        - 4                                    => "کلمه عبور یا کد فروشنده اشتباه است.",
        - 5                                    => "خطا در پایگاه داده رخ داده است.",
